...
dt <- read.csv(file = "data/Hawaii.csv")
dt <- dt |> mutate(
  t = Year - min(Year), 
  Y = sqrt(Birds)
  )
...
ggplot() + 
  geom_point(data = dt, mapping = aes(x = t, y = Y)) + 
  geom_ribbon(data = CI.OLS, mapping = aes(x = t, ymin = lwr, ymax = upr), size = 0.5, alpha = 0.2, fill = "darkviolet", color = "darkviolet", linetype = "dashed") + 
  geom_line(data = CI.OLS, aes(x = t, y = fit), color = "darkviolet", size = 1.0) + 
  labs(x = "years from 1956", y = "square root of number of birds")
...
ggplot() + 
  geom_point(data = dt, mapping = aes(x = t, y = Y)) + 
  geom_ribbon(data = CI.AR1, mapping = aes(x = t, ymin = lwr, ymax = upr), size = 0.5, alpha = 0.2, fill = "red", color = "red", linetype = "dashed") + 
  geom_line(data = CI.AR1, aes(x = t, y = fit), color = "red", size = 1.0) + 
  labs(x = "years from 1956", y = "square root of number of birds")
...
ggplot() + 
  geom_point(data = dt, mapping = aes(x = t, y = Y)) + 
  geom_ribbon(data = CI.AR2, mapping = aes(x = t, ymin = lwr, ymax = upr), size = 0.5, alpha = 0.2, fill = "red", color = "red", linetype = "dashed") + 
  geom_line(data = CI.AR2, aes(x = t, y = fit), color = "red", size = 1.0) + 
  labs(x = "years from 1956", y = "square root of number of birds")
...
ggplot() + 
  geom_point(data = dt, mapping = aes(x = t, y = Y)) + 
  geom_ribbon(data = CI, mapping = aes(x = t, ymin = lwr, ymax = upr, col = model, fill = model), size = 0.5, alpha = 0.2, linetype = "dashed") + 
  geom_line(data = CI, aes(x = t, y = fit, col = model), size = 1.0) + 
  labs(x = "years from 1956", y = "square root of number of birds")
